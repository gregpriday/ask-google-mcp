...
function printHelp() {
  ...
  console.log("  ASK_GOOGLE_FALLBACK_MODEL       Model used for last attempt when the requested tier keeps failing (default: flash)");
  ...
  console.log("  ASK_GOOGLE_ENABLED_MODELS       Comma-separated aliases to expose: flash, flash-lite (default: all)");
  console.log("  ASK_GOOGLE_ROUTER_ENABLED       Enable auto-routing (default: true). When false, model defaults to flash.");
